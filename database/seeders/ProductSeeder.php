...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::insert([
            ...
            [
                'category_id' => 7,
                'name' => 'Vở kẻ ngang 120 trang OCEAN JOURNEY',
                'price' => '9000',
                'description' => 'Vở kẻ ngang. Định lượng: 60 g/m2. Độ trắng 92% ISO. Số trang: 48 trang (không kể bìa). ️Chất liệu: Giấy dày, mịn, viết êm tay, tạo nét chữ đẹp. Đồng thời, giấy viết không bụi, không nhòe, không thấm mực sang trang sau.',
                'amount' => '83',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'category_id' => 7,
                'name' => 'Vở Tập Viết Chữ Hán - Vở Viết Tiếng Trung Loại Dày Khổ To (A4)',
                'price' => '45000',
                'description' => 'Vở tập viết chữ Hán ô chữ Điền dành cho người mới bắt đầu học tiếng Trung và người muốn luyện chữ Hán đẹp. Chất lượng giấy dày đẹp 100gsm, không bị lem mực. Ô chữ to vừa phải (1,4cm). Đặc biệt khổ giấy A4 - to và dày hơn các loại vở luyện chữ Hán khác có trên thị trường.',
                'amount' => '46',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            ...
            [
                'category_id' => 7,
                'name' => 'Vở may gáy kẻ ngang, vở caro ô vuông size B5',
                'price' => '35000',
                'description' => 'Nếu bạn vẫn còn đang tìm quyển vở ghi chép ưng ý - giấy dày mịn viết bút brush/highlight không sợ bị lem, thì JC xin giới thiệu với bạn dòng sổ ghi chép B5 Pastel Notebook sắp ra mắt tại JC Notebook. Sổ được làm bằng tay, handmade tại Việt Nam. Với chiếc bìa vở in mờ matte màu pastel, kèm vào đó là chiếc quote động lực ngắn, JC hy vọng sẽ đem đến năng lượng tích cực cho bạn vào những ngày đến trường.',
                'amount' => '41',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
